...
if not os.path.isdir("result/Experiment2/"+normalized_method):
  os.makedirs("result/Experiment2/"+normalized_method)


result_adj1_gcn_table = pd.read_table("data/gcng_output/"+normalized_method+"/adj1-exp2a/result_test_data.csv", sep=',', header=0, index_col=0)
result_adj2_gcn_table = pd.read_table("data/gcng_output/"+normalized_method+"/adj2-exp2a/result_test_data.csv", sep=',', header=0, index_col=0)
result_adj3_gcn_table = pd.read_table("data/gcng_output/"+normalized_method+"/adj3-exp2a/result_test_data.csv", sep=',', header=0, index_col=0)
result_adj4_gcn_table = pd.read_table("data/gcng_output/"+normalized_method+"/adj4-exp2a/result_test_data.csv", sep=',', header=0, index_col=0)
...
for eva in ["Accuracy", "Specificity", "Sensitivity"]:
  ...
  #plt.show()
  plt.savefig('result/Experiment2/'+normalized_method+'/'+eva+'.pdf')
  plt.clf()



with open("result/Experiment2/"+normalized_method+"/result.csv",'w', newline='') as f:
