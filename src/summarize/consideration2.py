...
"""
df_heat = pd.read_table("result/consideration/heatmap/positive.csv", sep=',', index_col=0)
...
for pattern in ["1111","1110","1101","1011","0111","1100","1010","1001","0110","0101","0011","1000","0100","0010","0001","0000"]:
  ...
  if len(pair_list)>0:
    save_path = 'result/consideration/expression_image/'+pattern+"("+str(len(pair_list))+")/"
